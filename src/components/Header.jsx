...
const navigate=useNavigate();
  ...
  return (
    <div className="fixed lg:left-72 left-0 lg:right-8 top-0 right-0 px-4 lg:pt-4 lg:px-0 backdrop-blur-md transition-all duration-300">
          ...
          {showMenu && (
            <div className="absolute flex flex-col right-6 mt-2 bg-white border border-gray-200 rounded shadow-lg z-10 p-2">
              <div className="p-4 text-gray-700">
                <span className="block font-semibold">Hey, {username}</span>
              </div>
              <button
